...
export class StockOutComponent implements OnInit {
 ...
 getStockOutList = (page?:number) => {
  ...
  this.stockService.showStockOutList(this.selectedPerPage,this.currentpage).subscribe((res) => {
    if(res.data) {
      this.stockOutList = res.data.result
  ...
  getIngredientDetail = (id) => {
   ...
   addIngredient = () => {
    ...
    const data = {
     ...
     this.stockService.addStockOut(data).subscribe((res) => {
